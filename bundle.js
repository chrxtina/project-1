...
/***/ function(module, exports, __webpack_require__) {
	...
	var playEvents = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayDoneButton = function displayDoneButton() {
	  $('.reset-board').css('display', 'block');
	};

	var hideDoneButton = function hideDoneButton() {
	...
	var resumePlay = function resumePlay() {
	  $('.cell').on('click', onClickCell);
	};

	var showNewGameButton = function showNewGameButton() {
	  $('#new-game').show();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexGame = function onIndexGame(event) {
	  event.preventDefault();
	  api.indexGame().done(ui.onIndexGameSuccess).fail(ui.failure);
	};
	...
	var onJoinGame = function onJoinGame(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.joinGame(data).done(ui.joinGameSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hideNewGameButton = function hideNewGameButton() {
	  $('#new-game').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "344c0322ab2bbeba25db28b17b15139b.jpg";
